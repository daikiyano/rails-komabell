                    ...
                    <section class="modal-card-body">
                        ...
                        <footer class="modal-card-foot">
                            <li style="list-style: none; margin: 0 auto;">
                                <ul><b-button style="width: 300px;" class="button" type="is-inline-dark" @click="passes(login)">Eメールで会員登録</b-button></ul>
                                <ul><b-button style="width: 300px;" class="button" type="is-inline-dark" @click="AuthGoogle"><img src="https://img.icons8.com/color/48/000000/google-logo.png" style="height: 15px;">Googleで会員登録</b-button></ul>
                                <ul><button style="width: 300px;" class="button" type="is-inline-dark" @click="AuthGithub"><img src="https://img.icons8.com/fluent/48/000000/github.png" style="height: 15px;"/>GitHubで会員登録</button></ul>
                                <ul><button style="width: 300px;" class="button" type="is-inline-dark" @click="AuthFacebook"><img src="https://img.icons8.com/fluent/48/000000/facebook-new.png" style="height: 15px;"/>Facebookで会員登録</button></ul>
